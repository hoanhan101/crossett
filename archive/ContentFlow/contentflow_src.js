...
var ContentFlowGlobal = {
    ...
    init: function () {
        ...
        this.addStylesheet(this.CSSBaseDir+'contentflow.css');    // FF2: without adding a css-file FF2 hangs on a reload.
        ...
        if (this.scriptElement.getAttribute('load')) {
            ...
            for (var i=0; i<AddOns.length; i++) {
                ...
                //if (AddOns[i] == 'myStyle') {
                    //this.addStylesheet(this.BaseDir+'contentflow.css');
                    //continue;
                //}
