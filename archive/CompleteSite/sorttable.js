...
var ml_tsort = {
  ...
  sort_col_style : "text-decoration:none; font-weight:normal; color:#333333", // whichever style you want the link to look like
  sort_col_class_post_sort : "def", // whichever class you want the heading for the column that's just sorted
  sort_col_style_post_sort : "text-decoration:none; font-weight:normal; color:#b21000", // whichever style you want the link to look like when the column for the link was sorted
  sort_col_mouseover : "this.style.color='#336699'", // what style the link should use onmouseover?
